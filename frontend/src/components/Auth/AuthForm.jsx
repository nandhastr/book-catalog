...
const AuthForm = ({ title, subtitle, buttonText, isLogin, onSubmit }) => {
                ...
                <form className="space-y-4" onSubmit={handleFormSubmit}>
                    {!isLogin && (
                        <div>
                            ...
                            <input type="text" placeholder="Masukkan nama" className="w-full border border-gray-300 rounded px-4 py-2 text-gray-700 focus:outline-none focus:border-blue-500 transition duration-200" value={name} onChange={(e) => setName(e.target.value)} />
                        </div>
                    )}
                    <div>
                    ...
                    {!isLogin && (
                        <>
                            ...
                            <div>
                                <LabelInput htmlFor="role" label="Pilih Role" />
                                <select id="role" className="w-full border border-gray-300 rounded px-4 py-2 text-gray-700 focus:outline-none focus:border-blue-500 transition duration-200" value={role} onChange={(e) => setRole(e.target.value)}>
