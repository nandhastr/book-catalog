...
const CardBook = ({ data, loading, limit }) => {
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
            {loading ? (
                ...
                displayedBooks.map((book) => (
                    <div key={book.id}  className="card flex flex-col justify-between items-center pb-2 w-40 h-70 bg-white rounded-t-md rounded-b-none shadow-lg hover:shadow-xl transition duration-300 relative hover:cursor-pointer group">
